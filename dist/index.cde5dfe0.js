...
let holderMask = new (0, _inputmaskDefault.default)({
    regex: "[A-Za-z ]*"
});
holderMask.mask(cardHolder);
let cardDate = document.getElementById("expiration-date");
let dateMask = new (0, _inputmaskDefault.default)("99/99");
...
cardDate.addEventListener("blur", ()=>{
    ...
    if (!(0, _creditcardJs.isExpirationDateValid)(buffDate[0], `20${buffDate[1]}`)) {
...
CVVCode.addEventListener("blur", ()=>{
    ...
    if (!(0, _creditcardJs.isSecurityCodeValid)(cardNum.value.replace(/\s+/g, ""), CVV)) {
...
function flip() {
    ...
    for (const side of arrOfSides)side.classList.toggle("active-background--true");
}
function checkPaymentSys() {
    const name = (0, _creditcardJs.getCreditCardNameByNumber)(cardNum.value.replace(/\s+/g, ""));
    ...
    switch(name){
        case "Credit card is invalid!":
            return;
        case "Visa":
            imagePath = new URL(require("58397e50d93e81ee")).href;
            let vb = (0, _redom.el)("img", {
                src: imagePath,
                alt: "Visa",
                class: "logo-pic"
            });
            (0, _redom.mount)(logoBlock, vb);
            break;
        case "Mastercard":
            imagePath = new URL(require("5e333a8ff634343")).href;
            let mcb = (0, _redom.el)("img", {
                src: imagePath,
                alt: "MasterCard",
                class: "logo-pic"
            });
            (0, _redom.mount)(logoBlock, mcb);
            break;
        default:
            let bank = (0, _redom.el)("div", name + "");
            bank.classList.add("bank-txt");
            document.querySelector(".system__logo").style.cssText = "width:max-content;";
            (0, _redom.mount)(logoBlock, bank);
    }
    console.log(name);
}
...
},{}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eAlq8":[function(require,module,exports) {
module.exports = require("de5eb2a91e9d5c70").getBundleURL("armsG") + "Visa.e895d095.png" + "?" + Date.now();

},{"de5eb2a91e9d5c70":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"ch5K0":[function(require,module,exports) {
module.exports = require("91d4bdbd2964ee8d").getBundleURL("armsG") + "MC.3d30f273.png" + "?" + Date.now();

},{"91d4bdbd2964ee8d":"lgJ39"}]},["2Yh4E","jUTag"], "jUTag", "parcelRequireff9c")
