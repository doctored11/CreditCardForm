...
import { card, arrOfSides, buyBtn, cardZone, cardNum } from "./domBuilder.js";
...
function checkPaymentSys() {
  ...
  switch (name) {
    case "Credit card is invalid!":
      return;
    case "Visa":
      imagePath = new URL("../source/Visa.png", import.meta.url).href;

      let vb = el("img", { src: imagePath, alt: "Visa", class: "logo-pic" });
      mount(logoBlock, vb);
      break;
    case "Mastercard":
      imagePath = new URL("../source/MC.png", import.meta.url).href;
